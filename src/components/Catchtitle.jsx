    ...
    return(
        <div className="container pt-10  ">
            ...
            <div className="div sm:flex items-center gap-8 sm:pl-0 pl-4">
                ...
                <div><span className="text-[18px] text-[#98989A] ">Explore the latest news from around the world. We bring you up-to-the-minute updates on the most significant events, trends, and stories. Discover the world through our news coverage.</span></div>
            </div>
        </div>
    )
}